...
1.  Use the `count()` function with the data you created in Task 1.3 to verify that year 2000 and 2020 remained in the year variable.
...
4.  Add labels to the bars by copying the code below this bullet point and adding it to your code for the plot.
